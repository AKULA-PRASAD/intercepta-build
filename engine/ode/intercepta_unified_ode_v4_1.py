#!/usr/bin/env python3
"""
INTERCEPTA Unified Tumor Dynamics ODE — v4.1
============================================
4 states x 20 bins = 80 compartments.

v4.1 changes vs v4 (two sourced-parameter corrections, nothing else):
...
N_BINS_DEFAULT = 20
R_MAX          = 0.00678      # /day. mCRPC pre-treatment g median (Stein 2011 Clin Cancer Res,
                                # 268 mCRPC patients across 5 NCI trials, median log g ~ -2.15)

...
| V14 | V9 drug-specific transfer EXTERNALLY REPLICATES in PDXE (public patient-derived xenografts) — B7 | Independent cohort, CROSS-CANCER + CROSS-MODEL-SYSTEM (solid-tumor PDX vs AML patients). Proliferation-residualized diagonal ρ=+0.057 > off-diagonal −0.025 (diff +0.082), permutation p=0.036, 9 GDSC-overlapping drugs. **Caveats:** borderline p, small n=9 drugs; overall transfer MAGNITUDE underpowered (H1 diag +0.053, p=0.14); PDX = patient-PROXY (xenograft), not human clinical. First cross-cohort+cross-cancer external replication of the drug-specific signal — upgrades confidence in V9. | B7_metrics.json |

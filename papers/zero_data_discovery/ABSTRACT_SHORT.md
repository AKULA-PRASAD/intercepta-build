...
spanning three phyla, and, in a **prospective-blind suite of four never-seen pathogens across multiple phyla** (predictions locked before the
answer was consulted), clears the gate in three — *N. gonorrhoeae* (OR 6.1), *C. jejuni* (OR 3.9), *Bacteroides
thetaiotaomicron* (a new phylum, OR 8.0) — and honestly fails the fourth (*S. pneumoniae*, OR 3.0, a sparse de-novo
model), giving a real deployment envelope rather than a suspiciously-perfect sweep.
